...
std::string request::accept_language();
std::string request::document_root();
std::string request::http_cookie() { return conn_->getenv("HTTP_COOKIE"); }
std::string request::http_forwarded()
std::string request::http_host();
std::string request::http_forwarder();
std::string request::http_referrer();
